...
func (o EncodeOptions) PCMFrameLen() int {
	// DCA needs this
	return 960 * o.Channels * (o.FrameDuration / 20)
}
...
func (o *EncodeOptions) Validate() error {
	...
	if o.FrameDuration != 20 && o.FrameDuration != 40 && o.FrameDuration != 60 {
	...
	if o.Application != AudioApplicationAudio && o.Application != AudioApplicationVoip && o.Application != AudioApplicationLowDelay {
...
func (e *EncodeSession) run() {
	...
	args := []string{
		...
		"-b:a", strconv.Itoa(e.options.Bitrate),
...
// Note: If raw output is not set, the first frame will be a metadata frame
